...
export default function FMModule() {
  const {
    rows,
    summaryCards,
    docTypeChart,
  ...
  return (
    <div className="p-8 bg-background text-foreground min-h-screen space-y-6">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Financial Management(FM)</h1>
        <p className="text-sm text-muted-foreground mt-1">Track document adherence and compliance status in FM subsystem</p>
      </div>
