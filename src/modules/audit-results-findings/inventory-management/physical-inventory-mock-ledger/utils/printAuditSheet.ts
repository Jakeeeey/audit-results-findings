...
<head>
    <meta charset="utf-8" />
    <title>Mock Ledger Audit Sheet</title>
    <style>
        * {
...
<body>
    <div class="header-title">MOCK LEDGER AUDIT SHEET</div>
    <div class="header-subtitle">${escapeHtml(header.ph_no || `ML #${header.id}`)}</div>
