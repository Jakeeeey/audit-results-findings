...
export type MockLedgerHeaderRow = {
    id: number;
    ph_no: string | null;
...
export type MockLedgerHeaderUpsertPayload = {
    ph_no?: string | null;
    cutOff_date: string | null;
    starting_date: string | null;
    price_type: number | null;
...
export type MockLedgerFiltersType = {
    branch_id: number | null;
    supplier_id: number | null;
    category_id: number | null;
...
export type MockLedgerListRow = MockLedgerHeaderRow & {
    branch_name?: string | null;
