...
import { MockLedgerStatusBadge } from "./MockLedgerStatusBadge";

type Props = {
    rows: MockLedgerHeaderRow[];
    branches: BranchRow[];
    ...
    isLoading?: boolean;
    onCreateNew: () => void;
    onOpen: (row: MockLedgerHeaderRow) => void;
};
...
export function MockLedgerList(props: Props) {
    const {
        rows,
        branches,
        suppliers,
                                ...
                                {isLoading ? (
                                    ...
                                    filteredRows.map((item) => (
                                        <TableRow key={item.row.id}>
                                            ...
                                            <TableCell>
                                                <MockLedgerStatusBadge status={item.status} />
                                            </TableCell>
