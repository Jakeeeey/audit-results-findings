...
import type { MockLedgerHeaderRow, PhysicalInventoryStatus } from "../types";
...
type Props = {
    header: MockLedgerHeaderRow | null;
...
export function MockLedgerHeader(props: Props) {
    const {
        header,
        status,
        canEdit,
                    ...
                    <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div className="flex min-w-[180px] items-center justify-between gap-3 rounded-2xl border bg-background px-4 py-3 shadow-sm">
                            <div className="min-w-0">
                                ...
                                <div className="mt-1">
                                    <MockLedgerStatusBadge status={status} />
                                </div>
                            </div>
            ...
            <CardContent className="space-y-5 pt-5">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <div className="space-y-2">
                        <Label htmlFor="pi-ph-no">ML No</Label>
                        <Input
                            id="pi-ph-no"
                            value={header?.ph_no ?? ""}
