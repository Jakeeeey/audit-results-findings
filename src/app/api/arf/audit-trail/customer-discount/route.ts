...
export async function GET(req: NextRequest): Promise<NextResponse> {
    ...
    try {
        ...
        const upstreamUrl = new URL(
            `${SPRING_API_BASE_URL.replace(/\/$/, "")}/api/view-customer-discount-log/filter`,
        );

        // Forward all query params (startDate, endDate, actionType, customerCode, supplierName, categoryName, changedByName)
