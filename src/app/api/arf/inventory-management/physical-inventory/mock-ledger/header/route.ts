//src/app/api/arf/inventory-management/physical-inventory/header/route.ts
...
export async function POST(req: NextRequest): Promise<NextResponse> {
    try {
        ...
        const payload = {
            ml_no: normalizeString(body.ph_no).trim(),
            cutOff_date:
        ...
        const upstream = new URL("/items/mock_ledger", DIRECTUS_BASE_URL);
