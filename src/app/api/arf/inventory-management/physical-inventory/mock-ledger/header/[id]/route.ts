//src/app/api/arf/inventory-management/physical-inventory/header/[id]/route.ts
...
export async function PATCH(
    ...
    try {
        ...
        if ("ph_no" in body) payload.ml_no = typeof body.ph_no === "string" ? body.ph_no.trim() : "";
        ...
        const upstream = new URL(`/items/mock_ledger/${id}`, DIRECTUS_BASE_URL);
