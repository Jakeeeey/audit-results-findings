...
import { NavUser } from "../_components/nav-user"; // Adjust this relative path if your nav-user is located elsewhere!

import { cookies } from "next/headers";

// 🚀 Wire the brand new ARF module!
import RemittanceAuditModule from "@/modules/audit-results-findings/remittance-audit/RemittanceAuditModule";
